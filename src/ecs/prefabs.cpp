...
namespace prefabs {
	static constexpr float TILESIZE = 16.0f / 1024.0f;
	
	entt::entity player(entt::registry& registry) {
		entt::entity e = registry.create();
		registry.emplace<Position>(e, glm::vec2(0.0f, 0.0f));
		registry.emplace<Sprite>(e, glm::vec2(24.0f), glm::vec4(TILESIZE * 8.0f, TILESIZE * 1.0f, TILESIZE, TILESIZE), 0.0f, glm::vec2(0.0f), glm::vec4(0.0f), -0.2f);
	...
	entt::entity base_enemy(entt::registry& registry, glm::vec2 pos, entt::entity target) {
		...
		registry.emplace<MoveTowards>(e, target, 1.5f);
		registry.emplace<Sprite>(e, glm::vec2(24.0f), glm::vec4(TILESIZE * 0.0f, TILESIZE * 5.0f, TILESIZE, TILESIZE), 0.0f, glm::vec2(0.0f), glm::vec4(0.0f), -0.1f);
	...
	entt::entity item_mana(entt::registry& registry) {
		...
		registry.emplace<Sprite>(e, glm::vec2(16.0f), glm::vec4(TILESIZE * 10.0f, TILESIZE * 2.0f, TILESIZE, TILESIZE), 0.0f, glm::vec2(0.0f), glm::vec4(0.0f), 0.0f);
		return e;
	}
	...
	entt::entity attack_swing(entt::registry& registry, glm::vec2 pos, glm::vec2 dir) {
		...
		registry.emplace<Sprite>(e, glm::vec2(16.0f, 32.0f), glm::vec4(TILESIZE * 9.0f, TILESIZE * 12.0f, TILESIZE, TILESIZE * 2.0f), 0.0f, glm::vec2(0.0f, 1.0f), glm::vec4(0.0f), 0.0f);
	...
	entt::entity attack_lavazone(entt::registry& registry, glm::vec2 pos) {
		...
		registry.emplace<Position>(e, pos);
		registry.emplace<Sprite>(e, glm::vec2(96.0f), glm::vec4(0.0f * TILESIZE, 56.0f * TILESIZE, TILESIZE * 8.0f, TILESIZE * 8.0f), 0.0f, glm::vec2(0.0f), glm::vec4(0.0f), -1.0f);
		registry.emplace<Attack>(e, 0.0f, 6.0f);
		registry.emplace<DamageZone>(e, 5.0f, 96.0f, DamageLayer::ENEMY, std::unordered_set<entt::entity>{}, 30);
