...
namespace prefabs {
	...
	entt::entity player(entt::registry& registry) {
		...
		registry.emplace<Sprite>(e, glm::vec2(32.0f), glm::vec4(0.0625f * 1.0f, 0.0625f * 5.0f, 0.0625f, 0.0625f));
	...
	entt::entity base_enemy(entt::registry& registry) {
		...
		registry.emplace<Sprite>(e, glm::vec2(24.0f), glm::vec4(0.0f, 0.0f, 1.0f, 1.0f));
	...
	entt::entity item_mana(entt::registry& registry) {
		...
		registry.emplace<Sprite>(e, glm::vec2(18.0f), glm::vec4(0.0625f * 10.0f, 0.0625f * 2.0f, 0.0625f, 0.0625f));
		return e;
	}
}
